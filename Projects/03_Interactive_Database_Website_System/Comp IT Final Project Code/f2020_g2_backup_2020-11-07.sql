...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2020 at 06:54 PM
...
(11, '355-9993', '10/2020', 24, 218, 88, 37.09, 348.5, 108, 29.62, 212.6, 118, 9.57, 7.5, 7, 2.03, 3),
...
(14, '358-1921', '11/2020', 1, 251, 100, 42.68, 120.3, 120, 10.28, 158.6, 100, 7.5, 12.4, 3, 3.48, 0),
...
('330-6626', 'Dean', 'Male', 41, 2012, 'B001'),
('335-4719', 'Jack', 'Male', 47, 2015, 'A001'),
('355-9993', 'Sam', 'Male', 35, 2015, 'B001'),
...
--
ALTER TABLE `promotion_customer`
  MODIFY `suggestion_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
