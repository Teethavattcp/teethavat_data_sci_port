...
<form action="update_customer.php" method="get">
		<p>
			...
			Number of customer service calls made (CustServ Calls): <input type="text" name="customer_custserv_calls" required value=<?php echo $customer_custserv_calls;?>>
			<br><br>
...
<br><a href = add_or_edit_customer.php?customer_phone_no=<?php echo "$customer_phone_no";?>>back</a>
</html>
